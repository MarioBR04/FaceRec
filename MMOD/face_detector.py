...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--processes', type=int, default=1, help='Number of parallel processes')
    parser.add_argument('-d', '--dataset', type=str, required=True, help='Path to the image dataset')
